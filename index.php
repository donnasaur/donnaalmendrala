		...
		<div class="content">
			...
			<h1>Design</h1>
				<div class="subcontents">
					...
					<div class="thumb python2"><a class="fancybox_gallery" href="images/python2.png" rel="pythoncomics" title="Static Image 2 for Design of Pythoncomics.com">Python Comics 2</a></div>
					<div class="thumb python3"><a class="fancybox_gallery" href="images/python3.png" rel="pythoncomics" title="Static Image 3 for Design of Pythoncomics.com">Python Comics 3</a></div>
					<div class="clear"></div>
				</div>
		</div>
